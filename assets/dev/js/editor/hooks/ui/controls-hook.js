export default class ControlsHook extends $e.modules.hookUI.After {
	...
	getId() {
		...
		return 'hello-joint-editor-controls-handler';
	}
	 ...
	 *   {
	 *      hello_joint_show_logo: '.site-header .site-header-logo',
	 *      hello_joint_show_menu: '.site-header .site-header-menu',
	 *   }
	 */
		...
		return {
			...
			hello_header_logo_type: {
				...
				callback: ($element, args) => {
					const classPrefix = 'show-',
						inputOptions =
							args.container.controls.hello_header_logo_type
								.options,
			...
			hello_header_layout: {
				...
				callback: ($element, args) => {
					const classPrefix = 'header-',
						inputOptions =
							args.container.controls.hello_header_layout.options,
			...
			hello_header_width: {
				...
				callback: ($element, args) => {
					const classPrefix = 'header-',
						inputOptions =
							args.container.controls.hello_header_width.options,
			...
			hello_header_menu_layout: {
				...
				callback: ($element, args) => {
					const classPrefix = 'menu-layout-',
						inputOptions =
							args.container.controls.hello_header_menu_layout
								.options,
			...
			hello_header_menu_dropdown: {
				...
				callback: ($element, args) => {
					const classPrefix = 'menu-dropdown-',
						inputOptions =
							args.container.controls.hello_header_menu_dropdown
								.options,
			...
			hello_footer_copyright_display: {
				...
				callback: ($element, args) => {
					const $footerContainer = $element.closest('#site-footer'),
						inputValue =
							args.settings.hello_footer_copyright_display;
			...
			hello_footer_logo_type: {
				...
				callback: ($element, args) => {
					const classPrefix = 'show-',
						inputOptions =
							args.container.controls.hello_footer_logo_type
								.options,
			...
			hello_footer_layout: {
				...
				callback: ($element, args) => {
					const classPrefix = 'footer-',
						inputOptions =
							args.container.controls.hello_footer_layout.options,
			...
			hello_footer_width: {
				...
				callback: ($element, args) => {
					const classPrefix = 'footer-',
						inputOptions =
							args.container.controls.hello_footer_width.options,
			...
			hello_footer_copyright_text: {
				...
				callback: ($element, args) => {
					const inputValue =
						args.settings.hello_footer_copyright_text;
	 ...
	 *
	 * This will remove the .show and .hide classes from the element, then apply the new class
	 *
	 * @param  element
	 * @param  inputValue
	 */
