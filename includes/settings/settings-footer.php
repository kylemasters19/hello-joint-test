...
class Settings_Footer extends Tab_Base {
	...
	protected function register_tab_controls() {
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SWITCHER,
				'label' => __( 'Copyright', 'hello-joint' ),
				'default' => 'yes',
				'label_on' => __( 'Show', 'hello-joint' ),
				'label_off' => __( 'Hide', 'hello-joint' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'All rights reserved', 'hello-joint' ),
			]
		);
	...
	public function get_additional_tab_content() {
		if ( ! defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			return sprintf( '
				...
				',
				__( 'Create a custom footer with multiple options', 'hello-joint' ),
			...
			return sprintf( '
				...
				',
				__( 'Create a custom footer with the new Theme Builder', 'hello-joint' ),
				__( 'With the new Theme Builder you can jump directly into each part of your site', 'hello-joint' ),
				__( 'Create Footer', 'hello-joint' ),
				get_template_directory_uri() . '/assets/images/go-pro.svg',
